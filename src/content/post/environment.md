...
```js title="Cite this work"
Data for Afghanistan. (2024). Houses affected in a natural disaster event [Data visualization].
https://www.dataforafghanistan.org/environment/child-mortality. Licensed under CC BY-ND-NC 4.0.
```
